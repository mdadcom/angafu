...
urlpatterns = [
    ...
    path('affpays/', affpays, name='affpays'),
    ...
    path('affville/', affville, name='affville'),
    ...
    path('affkartie/', affkartie, name='affkartie'),
    path('addkartie/', addkarti, name='addkartie'),
    path('deletequartie/<int:quartie_id>/', deletequartie, name='deletequartie'),
    path('updatekartie/<int:quartie_id>/', updatekartie, name='updatekartie'),
    path('affeditquartie/<int:quartie_id>/', affeditquartie, name='affeditquartie'),
    path('addheure/', addheure, name='addheure'),
    path('affligne/', affligne, name='affligne'),
    path('addligne/', addligne, name='addligne'),
    path('deleteligne/<int:ligne_id>/', deleteligne, name='deleteligne'),
    path('affeditligne/<int:ligne_id>/', affeditligne, name='affeditligne'),
